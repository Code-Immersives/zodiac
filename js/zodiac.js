...
function swapPicOrQuiz () {
  ...
  if (isQuiz == false) {
 // if we are NOT in Quiz Mode, serve up pic, character, text and sound
 ...
 // isQuiz==true we are not in the default mode, but rather in Quiz Mode
 ...
 // if user clicked incorrect thumb pic
